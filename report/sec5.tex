...
Nevertheless, almost one million people (\num{936037}, $3.44\%$ of the total population) live in municipalities belonging to classes 3 and 4, which indicates limited accessibility to healthcare services. 
...
Figure \ref{boxplot:acc_by_comm_2023n3} is a boxplot of travel times to reach the 3 closet medical centres.
The median value of $\qty{17.8}{\min}$ indicates that half of the municipalities require less than this time to reach the facilities, while the first and third quartiles ($13.7$ and $\qty{25.8}{\min}$, respectively) show that $50\%$ of the municipalities fall within an interquartile range of approximately $\qty{12}{\min}$. 
...
Percentage change in time was obtained with the following query, which implements this formula:
\begin{equation*}
