...
The Pareto chart in Figure \ref{pareto:pop_by_comm_class} highlights the highly uneven distribution of the Italian population across municipalities of different size classes.
The bars show that the largest share of residents is concentrated in municipalities with 10,000–49,999 inhabitants, followed by those in the 1,000–4,999 and 100,000–499,999 classes. 
By contrast, the smallest municipalities (<1,000 inhabitants) account for only a marginal fraction of the total population despite being very numerous in absolute terms.
Looking at the chart it is possible to state that \emph{more than 60\% of Italian population lives in communes with 50,000 inhabitants}. 
